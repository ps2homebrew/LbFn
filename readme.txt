...
●免責
・ライセンスは、基本的にLbFやLaunchELFと同じ
・自己責任で使ってください。配布自由。
・LbFnで改変した部分をyi氏に問い合わせたりしないでください。
・tek展開ルーチン(tek.c)やJPEG展開ルーチン(jpeg.c)のライセンスはKL-01です。
...
・JPEG展開ルーチン
  nikq氏, くーみん氏、川合秀実氏, I.Tak氏. あっきぃ氏
